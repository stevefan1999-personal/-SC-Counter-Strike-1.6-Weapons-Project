...
class weapon_aug : ScriptBasePlayerWeaponEntity, CS16BASE::WeaponBase
{
    ...
    void PrimaryAttack()
    {
        ...
        if( !( m_pPlayer.pev.flags & FL_ONGROUND != 0 ) )
            AUGFire( 0.035f + 0.4f * m_flAccuracy, flCycleTime, false );
        else if( m_pPlayer.pev.velocity.Length2D() > 140 )
            AUGFire( 0.035f + 0.07f * m_flAccuracy, flCycleTime, false );
        else
            AUGFire( 0.02f * m_flAccuracy, flCycleTime, false );
    }
    ...
    void AUGFire( float flSpread, float flCycleTime, bool fUseAutoAim )
    {
        ...
        {
            KickBack( 1.0, 0.45, 0.275, 0.05, 5.0, 2.0, 7 );
        }
        else if( m_pPlayer.pev.flags & FL_DUCKING != 0 )
        {
            KickBack( 0.575, 0.325, 0.2, 0.011, 4.75, 1.25, 9 );
        }
        else
        {
            KickBack( 0.625, 0.375, 0.25, 0.0125, 5.0, 1.5, 8 );
        }
