...
class weapon_m3 : ScriptBasePlayerWeaponEntity, CS16BASE::WeaponBase
{
    ...
    void PrimaryAttack()
    {
        ...
        M3Fire( 0.0675f, RPM_PUMP, false );
    }

    void M3Fire( float flSpread, float flCycleTime, bool fUseAutoAim )
    {
        ...
        if( !( m_pPlayer.pev.flags & FL_ONGROUND != 0 ) )
            m_pPlayer.pev.punchangle.x = Math.RandomFloat( -8.0f, -11.0f );
        else
            m_pPlayer.pev.punchangle.x = Math.RandomFloat( -4.0f, -6.0f );
